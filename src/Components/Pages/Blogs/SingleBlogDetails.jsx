    ...
    return (
        <div className="">
            ...
            <div className="relative py-16 bg-gradient-to-r from-teal-50 to-teal-100 border-b border-teal-200">
                {/* Back Button */}
                <div className="max-w-7xl mx-auto px-4 mb-6 pt-10">
                    <motion.button
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
            ...
            <div className="max-w-4xl mx-auto px-4 my-12">
                ...
                >
                    <div className="text-gray-700 leading-relaxed space-y-6">
                        ...
                        <p className="text-lg text-gray-700 leading-8">
                            Recusandae ipsum adipisci praesentium, optio error commodi distinctio repellat voluptate inventore necessitatibus! Quisquam est omnis consequatur a laudantium laboriosam similique id accusantium cupiditate beatae saepe aspernatur ab consequuntur eos nesciunt, sequi, explicabo expedita.
                        </p>
                    </div>
